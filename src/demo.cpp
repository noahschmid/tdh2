...
int main(int argc, char* argv[]) {
	...
	// custom group with p of 2048 bit and q of 256 bit
	...
	*/
	...
	float avg = (float)total_time/(float)k;
	std::cout << "average share generation time: " << avg << "\n";
	...
	std::cout << "decrypted message: " << hex2string(unlock(message)) << "\n";
}